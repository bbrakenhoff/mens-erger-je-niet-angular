...
import { createDice, dice } from 'app/factories/dice.token';
import { createPlayers, players } from 'app/factories/players.token';

@NgModule({
  declarations: [DetermineFirstPlayerComponent],
  exports: [DetermineFirstPlayerComponent],
  providers: [
    { provide: 'Players', useFactory: createPlayers },
    { provide: 'Dice', useFactory: createDice},
